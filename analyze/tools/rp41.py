...
disfn('_ZN11CMainScreen15UpdateTopScreenEv')
# CTopScreen methods that read player resources for bars
for nm,a,z in syms:
    if '11CTopScreen' in nm and any(k in nm for k in ['Energy','Blood','Happy','Brave','Moral','Refresh','SetValue','UpdateInfo','SetInfo','SetData','Money','Update']):
        print(f"  CTopScreen cand: 0x{a:08x} sz=0x{z:x} {nm}")
