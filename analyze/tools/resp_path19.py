"""gettopmsgs busy-loop: reverse CTopScreen::ParseMsg @0x592fb4 (fields + any
state flag) and scan CTopScreen::HandleUpdate @0x5918c8 / RequestMsg /
SetRollingText for the gettopmsgs request gate (what response stops re-polling)."""
import os, struct
...
disfn('_ZN10CTopScreen8ParseMsgEPv', label='CTopScreen::ParseMsg (gettopmsgs parser)')
disfn('_ZN10CTopScreen10RequestMsgEv', label='CTopScreen::RequestMsg')
disfn('_ZN10CTopScreen13RequestSysMsgEv', label='CTopScreen::RequestSysMsg')
disfn('_ZN10CTopScreen16OnRollingOneTimeEv', label='CTopScreen::OnRollingOneTime', L=0xa0)
